...
class ChatCSV:
    ...
    def __init__(self):
        ...
        self.prompt = PromptTemplate.from_template(
            """
            You are a helpful nutritionist that analyses different ingredients to come up with a meal plan.
            Use the following pieces of retrieved context to answer the question.
            Give Name when possible. Only answer questions related to meal planning.
    ...
    def ingest(self, folder_path: str):
        ...
        data = []
        # if not folder_path:
        #     folder_path = "D://Python_Projects//NIST_Chatbot//RAG_Chatbot"
...
start=ChatCSV()
start.ingest(folder_path = "D:\\Python_Projects\\NIST_Chatbot\\RAG_Chatbot")
app = FastAPI()

@app.get("/generate")
async def generate_text(prompt: str):
    # Generate text using the LLM model
    generated_text = start.ask(prompt)
